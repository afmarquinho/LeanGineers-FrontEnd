            ...
            >
              <Card className="card rounded-4 ovf-hidden" $darkMode={darkMode}>
                ...
                <div className="card__caption p-3 d-flex-column justify-content-between">
                  <div>
                    <h5 className="m-0 nombre">Coaching</h5>
                    <p className="m-0">
          ...
          <div className="p-3 course">
            ...
            >
              <Card className="card rounded-4 ovf-hidden" $darkMode={darkMode}>
                ...
                <div className="card__caption p-3 d-flex-column justify-content-between">
                  <div>
                    <h5 className="m-0 nombre">Toyota Kata</h5>
                    <p className="m-0">
                      Aprenderás: Lorem ipsum dolor sit amet consectetur,
                      adipisicing elit. Tempora, cum..
                    </p>
          ...
          <div className="p-3 course">
            ...
            >
              <Card className="card rounded-4 ovf-hidden" $darkMode={darkMode}>
                ...
                <div className="card__caption p-3 d-flex-column justify-content-between">
                  <div>
                    <h5 className="m-0 nombre">Gestión del cambio</h5>
                    <p className="m-0">
                      Aprenderás: Lorem ipsum dolor sit amet consectetur,
                      adipisicing elit. Tempora, cum..
                    </p>
          ...
          <div className="p-3 course">
            ...
            >
              <Card className="card rounded-4 ovf-hidden" $darkMode={darkMode}>
                ...
                <div className="card__caption p-3 d-flex-column justify-content-between">
                  <div>
                    <h5 className="m-0 nombre">Liderazgo situacional</h5>
                    <p className="m-0">
                      Aprenderás: Lorem ipsum dolor sit amet consectetur,
                      adipisicing elit. Tempora, cum..
                    </p>
...
const Container = styled.div`
  ...
  background-color: ${(props) =>
    props.$darkMode ? props.theme.other.dark : "#f3e6fa"};
`;
