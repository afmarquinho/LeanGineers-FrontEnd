...
const Banner = ({ title = "", contenido = "", clase = "", backgroundImage}) => {
  const { darkMode } = useDark();
  return (
    <Container fluid className="p-0">
      <IMGBgBanner className={`row ovf-hidden ${clase}`} $darkMode={darkMode} $backgroundImage={backgroundImage}>
            ...
            <div className="row h-100">
              <div className="col-12">
                <BannerContent className="banner m-0-auto h-100 d-flex-column justify-center align-center">
                  ...
                  <Title className="banner__title text-center">{title}</Title>
                </BannerContent>
              </div>
            </div>
          </div>
